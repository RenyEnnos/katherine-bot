...
## 2026-01-22 - [Interaction Visibility]
**Learning:** For auxiliary actions like "Copy", using `opacity-0 group-hover:opacity-100` keeps the UI clean but MUST be paired with `focus:opacity-100` (or `focus-within`) to remain accessible to keyboard users.
**Action:** Always verify that hover-reveal controls are also focus-reveal.
