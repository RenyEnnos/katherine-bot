...
## 2024-05-21 - Copy Button for AI Responses
**Learning:** Users frequently need to extract code or text from AI responses. Adding a dedicated copy button reduces friction compared to manual selection.
**Action:** Always consider "output utility" for AI-generated content - can it be copied, downloaded, or shared easily?
