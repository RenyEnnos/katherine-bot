            ...
            <div className={`flex max-w-[80%] md:max-w-[70%] ${isUser ? 'flex-row-reverse' : 'flex-row'} gap-4`}>
                ...
                <div className={`relative px-4 py-3 rounded-2xl shadow-sm text-sm md:text-base leading-relaxed ${isUser
                    ...
                    {!isUser && (
                        <button
                            onClick={handleCopy}
                            className="absolute -bottom-6 right-0 p-1 text-gray-500 hover:text-gray-300 transition-opacity opacity-100 md:opacity-0 md:group-hover:opacity-100 focus:opacity-100"
