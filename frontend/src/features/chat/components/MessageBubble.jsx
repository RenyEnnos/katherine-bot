                ...
                <div className={`flex flex-col ${isUser ? 'items-end' : 'items-start'} min-w-0`}>
                    ...
                    {!isUser && (
                        <button
                            ...
                            className={`mt-1 ml-1 p-1 rounded hover:bg-gray-800 transition-colors duration-200 text-gray-500 hover:text-gray-300 md:opacity-0 md:group-hover:opacity-100 focus:opacity-100 opacity-100`}
                        >
